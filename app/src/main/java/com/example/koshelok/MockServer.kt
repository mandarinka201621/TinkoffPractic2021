...
class MockServer @Inject constructor() : AppService {
    val list =
        mutableListOf(
            TransactionApi(0,"1234",0,0,"Супермаркет",0,
                Color.parseColor("#5833EE"),"RUB",1243554646426),
            TransactionApi(1,"34",0,0,"Супермаркет",1,
                Color.parseColor("#5833EE"),"RUB",1243554646426),
            TransactionApi(2,"12534",0,0,"Супермаркет",2,Color.parseColor("#5833EE"),"RUB",1243554646426),
            TransactionApi(3,"124",0,0,"Супермаркет",3,Color.parseColor("#5833EE"),"RUB",1243554646499),
            TransactionApi(4,"13534",0,0,"Супермаркет",4,Color.parseColor("#5833EE"),"RUB",1243554546426),
            TransactionApi(5,"11534",0,0,"Супермаркет",5,Color.parseColor("#5833EE"),"RUB",1243553446426),
            TransactionApi(6,"34",0,0,"Супермаркет",6,Color.parseColor("#5833EE"),"RUB",1243554646526),
            TransactionApi(7,"16432",0,0,"Супермаркет",1,Color.parseColor("#5833EE"),"RUB",1223554646426),
            TransactionApi(8,"123",0,0,"Супермаркет",0,Color.parseColor("#5833EE"),"RUB",124354646426),
            TransactionApi(9,"12784",0,0,"Супермаркет",4,Color.parseColor("#5833EE"),"RUB",1233554646426),
            TransactionApi(10,"123423",0,0,"Супермаркет",2,Color.parseColor("#5833EE"),"RUB",1273554646426),
        )
