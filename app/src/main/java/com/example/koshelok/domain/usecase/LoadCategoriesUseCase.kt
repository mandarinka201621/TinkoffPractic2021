...
interface LoadCategoriesUseCase {
    operator fun invoke(personId: Long, type: Int): Single<List<Category>>
}
...
class LoadCategoriesUseCaseImpl @Inject constructor(
    ...
    override fun invoke(personId: Long, type: Int): Single<List<Category>> {
        return loadCategoriesRepository.getCategories(personId, type)
    }
}
